...
extractTar(char tarName[])
{
	...
	for(int i = 0; i < nFiles; i++){
		...
		//int auxiliar = array[i].size; //Con esta variable auxiliar, debuggeara mejor
...
FILE* fileTar = NULL;
	...
	stHeaderEntry aux; //Variable auxiliar para la ordenacion por burbuja
	//Una vez leido el header, lo ordeno en funcion del tamanyo
	// de los archivos
	

	/* ORDENO POR EL METODO DE LA BURBUJA */
	...
	{ 
		...
		{ 
			...
			{ 
				...
				array[i].name = aux.name;
				array[i].size = aux.size;
